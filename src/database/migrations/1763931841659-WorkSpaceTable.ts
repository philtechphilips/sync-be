...
export class WorkSpaceTable1763931841659 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_8a19209e974992c7a01f121d0c" ON "workspace_members" ("invitation_token") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_5231bf8d0d63622937b83ea34a" ON "workspaces" ("workspace_url") `);
        await queryRunner.query(`CREATE INDEX "IDX_845271d9ec1e57bda19d404bfd" ON "workspaces" ("unique_key") `);
        ...
        await queryRunner.query(`ALTER TABLE "workspace_members" ADD CONSTRAINT "FK_4e83431119fa585fc7aa8b817db" FOREIGN KEY ("user_id") REFERENCES "auth_users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_845271d9ec1e57bda19d404bfd"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_5231bf8d0d63622937b83ea34a"`);
        await queryRunner.query(`DROP TABLE "workspaces"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_8a19209e974992c7a01f121d0c"`);
